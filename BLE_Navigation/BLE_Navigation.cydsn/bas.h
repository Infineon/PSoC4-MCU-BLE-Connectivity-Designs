...
#define BAS_MEASURE_LP_LED          (0)     /* Set to 1 to indicate <10% of measured battery level on LED */
#define BAS_SIMULATE_ENABLE         (1)     /* Set to 1 to enable Battery Level simulation */
#define BAS_SIMULATE_LP_LED         (0)     /* Set to 1 to indicate <10% of simulated battery level on LED */
...
#define BATTERY_TIMEOUT             (10u)       /* Counts of 0.5 second */
